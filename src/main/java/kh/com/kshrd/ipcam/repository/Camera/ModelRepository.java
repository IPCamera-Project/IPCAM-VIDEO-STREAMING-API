...
public interface ModelRepository {
    ...
    final String INSERT_NEW = "INSERT INTO tbl_model(name,vender_id,image) VALUES(#{name},#{vender_id},#{image})";

    final String UPDATE_MODEL = "UPDATE tbl_model SET (name = #{name},vendor_id = #{vendor_id},image = #{image})" +
